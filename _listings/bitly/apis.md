...
apis:
- name: Bitly - Get Link Shares
  x-api-slug: v3linkshares-get
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/shares/master/_listings/bitly/v3linkshares-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/shares/master/_listings/bitly/v3linkshares-get-openapi.md
x-common:
- type: x--net-library
